import threading #biblioteca para controle de processos
from pytube import YouTube #biblioteca do youtube em python
from time import sleep #importar sleep da biblioteca time para ter um pouco de delay dos processos
import vlc
import re, urllib.parse, urllib.request #controlador de expressões regulares com string
import pyttsx3

engine = pyttsx3.init()


# tocar o player no vlc como um player oculto
...
def get_music_youtube_link(music_name):
  Speak('Procurando por ' + music_name)
